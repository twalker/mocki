...
var fooPath = path.join(mocksPath, 'foo.json')
var barPath = path.join(mocksPath, 'bar.json')
var listPath = path.join(mocksPath, 'list.json')
var subPath = path.join(mocksPath, 'foo', 'subcollection')
var subResourcePath = path.join(subPath, 'baz.json')
